...
describe("View", () => {
  ...
  describe("move()", () => {
    ...
    it("может менять значение при перемещении мыши", () => {
      ...
      expect(view.config.value).toEqual([4000]);
  ...
  describe("setPosition()", () => {
    ...
    it("может устанавливать значение css slider__progress", () => {
      expect($(".slider__progress")).toHaveCss({
        left: "89.6px",
        width: "448px"
      });
    });
  ...
  describe("getPosition()", () => {
    ...
    it("может получать длинну slider__progress", () => {
      expect(view.getPosition(6000)).toEqual(268.8);
    });
  });
  ...
  describe("unbind()", () => {
    ...
    it("может удалять события", () => {
      ...
      expect($(document)).not.toHandleWith("scroll");
      expect($(window)).not.toHandleWith("resize");
